<template id="login-form">
  ...
  <div class="login-wrapper" style="align:center">
    <div class="login-left">
      <img height="500" src="https://is1-ssl.mzstatic.com/image/thumb/Purple118/v4/97/dc/66/97dc6653-3c64-4d82-d648-e374266eab22/source/512x512bb.jpg" srcr="https://preview.ibb.co/hUAr57/bar_bg.jpg">
    </div>
    <form class="login-right" @submit.prevent="register">
      <div class="h2">Register</div>
      <div class="form-group">
        <input type="text" id="username" placeholder="User name" v-model="username" autofocus>
        <label for="username">User name</label>    
      </div>
      <div class="form-group">
        <input type="text" id="firstname" placeholder="First name" v-model="firstname" autofocus>
      ...
      <div class="form-group">
        <input type="text" id="contact" placeholder="Contact number" v-model="contact">
      ...
      <div class="form-group">
        <input type="password" id="password2" placeholder="Confirm Password" v-model="password2">
