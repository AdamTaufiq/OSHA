<template id="login-form">
  ...
  <div class="login-wrapper" style="align:center">
    <div class="login-left">
      <img height="360" src="https://apis.soleet.my/fn/2019/7/4/45776644-f484-4403-adef-d57b61759707.UCUX_LOGO.png" srcr="https://preview.ibb.co/hUAr57/bar_bg.jpg">
    </div>
    <form class="login-right" @submit.prevent="login">
      <div class="h2">Login</div>
      <div class="form-group">
        <input type="text" id="email" placeholder="Email" v-model="email" autofocus>
